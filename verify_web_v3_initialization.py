...
checks = {
    ...
    "SCAP E4 is the initialized control profile": 'value="aggressive_profit" selected' in launcher and 'value="E4" selected' in launcher,
    ...
    "small account cash is initialized": 'id="initial_cash" min="1" step="1000" value="20000"' in launcher,
    "five-position limit is initialized": 'id="max_positions_account" min="0" step="1" value="5"' in launcher,
    "two-thousand cash buffer is initialized": 'id="min_cash_buffer" min="0" step="100" value="2000"' in launcher,
    ...
    "small-account replacement is visibly enabled and bounded": 'id="active_replacement_enabled" checked disabled' in launcher and '每日最多一组完整卖买配对' in launcher,
