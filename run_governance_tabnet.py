...
def run_backtest(gui):
    ...
    try:
        ...
        gui.root.after(0, lambda: gui.update_progress(0, total_days, "Training TabNet...", f"Processing {total_days} trading days"))
        
        ml_model = TabNetAlphaModel(lookback_days=500)
